...
|---|---:|---|
| MPU6050 SDA | 21 | Dữ liệu I2C |
| MPU6050 SCL | 22 | Xung clock I2C |
| LED | 26 | Tích cực mức cao |
| Buzzer | 27 | Tích cực mức cao |
| Nút hủy | 32 | Tích cực mức thấp, bật điện trở kéo lên nội |

MPU6050 sử dụng địa chỉ I2C `0x68`. Chân ngắt của cảm biến được dành sẵn tại GPIO 19 trong file cấu hình nhưng chưa được firmware sử dụng do hệ thống hiện đọc dữ liệu theo cơ chế polling.
